...
- __Ghost Circuits and Non-Consumables__: GT Machines and Crafting Input Bus/Buffers now include their recipe configurations in the terminal name as follows: _Machine Name_ [24] {Extruder Shape (Rod)}. This is fully configurable in `config/GregTech/Machines`
